...
const FEATURES = [
  {
    title: 'تسجيل عالي الجودة',
    description: 'تسجيل فيديو عالي الدقة مع وضوح الليل قدرات رؤية للمراقبة على مدار الساعة طوال أيام الأسبوع.',
    icon: (
  ...
  },
  {
    ...
    description: 'شاهد بثًا مباشرًا لما يراه روبوتك بالضبط، في أي وقت ومن أي مكان، عبر تطبيقنا المحمول الآمن.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
